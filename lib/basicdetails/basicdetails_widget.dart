...
import 'basicdetails_model.dart';
export 'basicdetails_model.dart';

/// Create a page with form to get basic details of the user
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Please fill in your basic information to complete your profile setup.',
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
